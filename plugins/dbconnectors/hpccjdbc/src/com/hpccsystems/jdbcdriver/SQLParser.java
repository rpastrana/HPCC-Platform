...
public class SQLParser
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		parser.process("select city, zip, count(*) from tutorial::rp::tutorialperson                       A S          persons where zip ='33445' limit 1000");
		System.out.println(parser.getWhereClauseString());
		System.out.println(parser.getTableName());
		if (parser.getTableAlias()!=null)
			System.out.println("Alias: " + parser.getTableAlias());
