    ...
    if (curlHandle)
    {
        ...
        */
        ...
        if (curlResponseCode != CURLE_OK)
        {
            ...
            {
            case 400L:
                throw makeStringExceptionV(-1,"%s KQL response: Error (400): Request is badly formed and failed (permanently): '%s'", COMPONENT_NAME, (curlErrBuffer[0] ? curlErrBuffer : ""));
            case 401L:
                throw makeStringExceptionV(-1,"%s KQL response: Error (401): Unauthorized - Client needs to authenticate first: '%s'", COMPONENT_NAME, (curlErrBuffer[0] ? curlErrBuffer : ""));
            case 403L:
                throw makeStringExceptionV(-1,"%s KQL response: Error (403): Forbidden - Client request is denied: '%s'", COMPONENT_NAME, (curlErrBuffer[0] ? curlErrBuffer : ""));
            case 404L:
                throw makeStringExceptionV(-1,"%s KQL request: Error (404): NotFound - Request references a non-existing entity. Ensure configured WorkspaceID is valid!: '%s'", COMPONENT_NAME, (curlErrBuffer[0] ? curlErrBuffer : ""));
            case 413:
                throw makeStringExceptionV(-1,"%s KQL request: Error (413): PayloadTooLarge - Request payload exceeded limits: '%s'", COMPONENT_NAME, (curlErrBuffer[0] ? curlErrBuffer : ""));
            case 429:
                throw makeStringExceptionV(-1,"%s KQL request: Error (429): TooManyRequests - Request has been denied because of throttling: '%s'", COMPONENT_NAME, (curlErrBuffer[0] ? curlErrBuffer : ""));
            case 504:
            ...
            case 520:
                throw makeStringExceptionV(-1,"%s KQL request: Error (520): Azure ServiceError - Service found an error while processing the request: '%s'", COMPONENT_NAME, (curlErrBuffer[0] ? curlErrBuffer : ""));
            default:
