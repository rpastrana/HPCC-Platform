...
#define COMPONENT_NAME "GrafanaCurlClient"
...
class GrafanaCurlClient : public CInterfaceOf<IRemoteLogAccess>
{
private:
    ...
    StringBuffer m_grafanaDataSourceName;
    StringBuffer m_grafanaDataSourceID;

public:
    GrafanaCurlClient(IPropertyTree & logAccessPluginConfig);
