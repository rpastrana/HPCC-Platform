...
IMultiException *xppMakeException(XmlPullParser &xppx)
{
	...
	if (strncmp(msg, "STF(", 4)!=0)
	{
		switch (code) //if unknown roxie code, send back: APPLICATION UNREACHABLE (PROD_MF_SWITCH)
		{
			case 1407: //Roxie timeout
				break;
			default:	//unknown Roxie code
				msg.clear().append("STF(0, 2):APPLICATION UNREACHABLE (PROD_MF_SWITCH)");
				break;
		}
	}
